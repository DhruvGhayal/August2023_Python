...
# return a False result, then the second elif-statement will run.
...
# then the else-statement will run. 
    else: translation = "Unknown error code"
...
print(translate_error_code("406 Not Found"))
# Expected output:
...
if number <= 5: print("The number is 5 or smaller.")
...
elif number == 33:print("The number is 33.") 
...
elif number < 32 and number >= 6:print("The number is less than 32 and greater than 6.")
else:print("The number is " + str(number)) 
# Expected output is: 
